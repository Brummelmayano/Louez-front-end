  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.dispatchEvent(new CustomEvent('toast', {
        detail: {
          type: 'success',
          message: 'Inscription réussie ! Bienvenue sur Louez.',
          duration: 3000
        }
      }));
      navigate('/');
    ...
    <div className="bg-background dark:bg-gray-900 min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center py-16 px-4">
        <div className="w-full flex justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden w-full max-w-2xl"> {/* max-w-2xl élargit le formulaire sur desktop */}
            <div className="p-10 sm:p-12">
              <div className="text-center mb-8">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Créer un compte</h1>
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                  Rejoignez la communauté Louez
                </p>
              </div>
              {/* Boutons sociaux AVANT le formulaire */}
              <div className="mb-8">
                <div className="flex flex-col gap-3">
                  <button
                    type="button"
                    onClick={() => googleLogin()}
                    className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm bg-white dark:bg-gray-800 text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700"
                  >
                  ...
                  >
                    ...
                    <span className="ml-2">S'inscrire avec Facebook</span>
                  </button>
                  */}
                </div>
